...
#visualize data
hist(tegula$algae_Wd[tegula$algae_spp.== 'macro'])
hist(tegula$algae_Wd[tegula$algae_spp.== 'sargassum'])
...
#T test
t.test(tegula$algae_Wd~tegula$algae_spp., paired= TRUE)

#make boxplot for tegula
tegplot<- ggplot(tegula, aes(x=algae_spp., y=algae_Wd, fill= algae_spp.))+ geom_boxplot() + theme_bw()  + guides() + xlab("Algae Species") + ylab(" Consumtion (g)") + ggtitle("M. pyrifera vs. S. horneri whole tissue consumption by T. funebralis") + theme(plot.title =element_text(hjust = 0.5)) 
tegplot #show boxplot
...
##Pachy
```{r}
#subset the Pachy rows
pachy<-subset(LabAssayWholeTissue, grazer_spp.== "Pachy")
#visualize data
hist(pachy$algae_Wd[pachy$algae_spp.== 'macro'])
hist(pachy$algae_Wd[pachy$algae_spp.== 'sargassum'])
#look at means and SDs
mean(pachy$algae_Wd[pachy$algae_spp.== 'macro'],na.rm = T)
sd(pachy$algae_Wd[pachy$algae_spp.== 'macro'],na.rm = T)
mean(pachy$algae_Wd[pachy$algae_spp.== 'sargassum'],na.rm = T)
sd(pachy$algae_Wd[pachy$algae_spp.== 'sargassum'],na.rm = T)

#T test
t.test(pachy$algae_Wd~pachy$algae_spp., paired= TRUE)

#make boxplot for Pachy
pachyplot<- ggplot(pachy, aes(x=algae_spp., y=algae_Wd, fill= algae_spp.)) + geom_boxplot() + theme_bw() + guides(fill=F) + xlab("Algae Species") + ylab(" Consumtion (g)") + ggtitle("M. pyrifera vs. S. horneri whole tissue Consumption by P. crassipes") + theme(plot.title =element_text(hjust = 0.5)) 
pachyplot #show boxplot
```

##Pagurus
```{r}

#subset the abalone rows
pagurus<-subset(LabAssayWholeTissue, grazer_spp.== "Pagurus")
#visualize data
hist(pagurus$algae_Wd[pagurus$algae_spp.== 'macro'])
hist(pagurus$algae_Wd[pagurus$algae_spp.== 'horneri'])
#look at means and SDs
mean(pagurus$algae_Wd[pagurus$algae_spp.== 'macro'],na.rm = T)
sd(pagurus$algae_Wd[pagurus$algae_spp.== 'macro'],na.rm = T)
mean(pagurus$algae_Wd[pagurus$algae_spp.== 'horneri'],na.rm = T)
sd(pagurus$algae_Wd[pagurus$algae_spp.== 'horneri'],na.rm = T)

#T test
t.test(pagurus$algae_Wd~pagurus$algae_spp., paired= TRUE)

#make boxplot for abalone
pagurusplot<- ggplot(pagurus, aes(x=algae_spp., y=algae_Wd, fill= algae_spp.)) + geom_boxplot() + theme_bw() + guides(fill=F) + xlab("Algae Species") + ylab(" Consumtion (g)") + ggtitle("M. pyrifera vs. S. horneri whole tissue Consumption by Pagurus") + theme(plot.title =element_text(hjust = 0.5)) 
pagurusplot #show boxplot
```
...
#visualize data
hist(abalone$algae_Wd[abalone$algae_spp.== 'macro'])
hist(abalone$algae_Wd[abalone$algae_spp.== 'sargassum'])
#look at means and SDs
mean(abalone$algae_Wd[abalone$algae_spp.== 'macro'],na.rm = T)
sd(abalone$algae_Wd[abalone$algae_spp.== 'macro'],na.rm = T)
mean(abalone$algae_Wd[abalone$algae_spp.== 'sargassum'],na.rm = T)
sd(abalone$algae_Wd[abalone$algae_spp.== 'sargassum'],na.rm = T)

#T test
t.test(abalone$algae_Wd~abalone$algae_spp., paired= TRUE)

#make boxplot for abalone
abplot<- ggplot(abalone, aes(x=algae_spp., y=algae_Wd, fill= algae_spp.)) + geom_boxplot() + theme_bw() +guides(fill = F) + xlab("Algae Species") + ylab(" Consumtion (g)") + ggtitle("M. pyrifera vs. S. horneri whole tissue Consumption by H. cracherodii") + theme(plot.title =element_text(hjust = 0.5)) 
abplot #show boxplot
