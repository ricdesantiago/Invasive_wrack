...
```{r}
#### lets test if consumption of WRACK differed. ie., is one wrack species less palatable than the other.?
...
perf_fig <- ggplot(performance, aes(x = diet, y = terminal_dry_tissue_mass, fill = diet)) +
  geom_boxplot(show.legend = FALSE) + scale_fill_manual( values = c("starved" = "white", "macro" = "white", "mixed" = "white", "sargassum" = "white") ) + theme_bw() + xlab("Diet") +
  ...
  scale_x_discrete( limits = c("starved", "macro", "mixed", "sargassum"), labels = c("starved" = "Starved", "macro" = "Kelp", "mixed" = "Mixed", "sargassum" = "Devilweed") ) + 
...
commplot <- ggplot(community, aes(x = Algae_trt, y = Algae_Wd, fill = fct_rev(Wrack_treatment))) + xlab("") + 
  ylab("Seaweed consumed (g)") + 
  ggtitle("") + theme() + geom_boxplot() + 
  theme_minimal() + 
  scale_x_discrete(limits = c("Wrack", "Centroceras", "Ulva", "Silvetia"), 
                   labels = c("Wrack" = "Kelp Devilweed", "Centroceras" = "C. clavulatum", "Ulva" = "Ulva spp", "Silvetia" = "S. compressa")) + 
  theme(axis.text = element_text(size = 14),
        axis.text.x = element_text(size = 14, color = "black"),
        axis.title.y = element_text(size = 12)) +
        geom_vline(xintercept = c(1.6), linetype = "dot") + 
        fabs(fill = "Wrack treatment") + 
  scale_fill_manual(values = c("Native" = "gray 80", "Invasive" = "white")) + 
  theme(legend.title = element_text(size = 12), panel.border = element_rect(color = "black", fill = NA, size = 0.5))
...
commplot <- ggplot(community, aes(x = Algae_trt, y = Algae_Wd, fill = fct_rev(Wrack_treatment))) +
  ...
  ylab("Seaweed consumed (g)") +
  geom_boxplot() +
  scale_x_discrete(limits = factor(c("Wrack", "Centroceras", "Ulva", "Silvetia")),
                   labels = c("Wrack" = "  Kelp    Devilweed", "Centroceras" = "C. clavulatum", "Ulva" = "Ulva spp", "Silvetia" = "S. compressa")) +
  theme_minimal() +
  theme(axis.text = element_text(size = 14),
        axis.text.x = element_text(size = 14, color = "black"),
