...
comm$logWd<-log10(comm$Algae_Wd)
view(comm)
...
# First, install and load the lsmeans package
install.packages("lsmeans")
library(lsmeans)


# Use the lsmeans() function to compute the least-squares means for each level of the treatment variable:
treatment_means <- lsmeans(commmodel3, "Algae_Spp.")

# Use the cld() function to conduct pairwise comparisons between the levels of the treatment variable:
comparisons <- cld(treatment_means, alpha = 0.05)
