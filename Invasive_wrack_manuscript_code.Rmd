...
fit = fitdist(NBS_Sub2[NBS_Sub2$Wrack_treatment == "Native" & NBS_Sub2$Algae_Spp. == "Silvetia",]$Algae_Wd, "pois", discrete=)

#practice
commmodel<-lme(Algae_Wd~Wrack_treatment*Algae_Spp., random = ~1 | Rep_No., data = NBS_Sub2)
summary(commmodel)
coef(commmodel)
...
fit <- lmer(Algae_Wd ~ Algae_Spp. + (1 | Rep_No.), data = NBS_Sub)
